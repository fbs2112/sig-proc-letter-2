...
w5 = cell(length(modulationIndexVector),1);
e5 = cell(length(modulationIndexVector),1);
meanCount3 = cell(length(modulationIndexVector),1);
...
save(['.' filesep 'results' filesep 'DFE_PNLMS.mat'],'w5','e5','meanCount3');
